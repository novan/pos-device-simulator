...
public class SimulatedDeviceWindow extends JFrame {
    ...
    private DeviceLegendMetaData legendPrinter = new DeviceLegendMetaData("Printer");
    private DeviceLegendMetaData legendCashDrawer = new DeviceLegendMetaData("Cash Drawer");
    ...
    public void init() {
        ...
        tabbedPane.addTab("POS Printer", SimulatedPOSPrinterPanel.getInstance());
        tabbedPane.addTab("Cash Drawer", SimulatedCashDrawerPanel.getInstance());
        tabbedPane.addTab("Sig Cap", SimulatedSignatureCapturePanel.getInstance());
        tabbedPane.addTab("MICR", SimulatedMICRPanel.getInstance());
        tabbedPane.addTab("Line Display", SimulatedLineDisplayPanel.getInstance());
        tabbedPane.addTab("Fiscal Printer", SimulatedFiscalPrinterPanel.getInstance());
    ...
    public void addToGridBag(int x, int y, int colspan, int rowspan, int fill, Component component, Container container) {
    ...
    private class DeviceLegendMetaData extends JPanel {
        ...
        public void update(boolean opened, boolean claimed, boolean enabled) {
            lblOpened.setBackground(opened ? Color.GREEN : Color.RED);
            lblClaimed.setBackground(opened ? Color.GREEN : Color.RED);
            lblEnabled.setBackground(opened ? Color.GREEN : Color.RED);
        }
