...
public class SimulatedLineDisplayPanel extends BaseSimulatedPanel {
    static final Log logger = LogFactory.getLog(SimulatedLineDisplayPanel.class);
        ...
        btnYes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (getCallbacks() != null) {
                	...
                	DirectIOEvent evt = new DirectIOEvent(new LineDisplay(), 1, 1, confirmMessage.getBytes());
